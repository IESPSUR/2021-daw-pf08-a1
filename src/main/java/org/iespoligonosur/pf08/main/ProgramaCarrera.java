...
public class ProgramaCarrera {
	...
	/**
	 * Este mÈtodo debe imprimir la estadÌstica de la carrera Fecha y Hora de la
	 * realizaciÛn DuraciÛn en minutos N˙mero de participantes Ranking de
	 * participantes Velocidad Punta M·xima y Jugador que la alcanzÛ Velocidad Media
	...
	private static void imprimeEstadisticaCarrera() {
		...
		System.out.println("DuraciÛn en Milisegundos: " + MILLIS.between(inicioPartida, finalPartida));
